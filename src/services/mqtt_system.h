...
/* Topicos externos simulados (sensores e controles) */
#define TOPIC_CASA_EXTERNO_LUMINOSIDADE "/casa/externo/luminosidade"
#define TOPIC_CASA_EXTERNO_TEMPERATURA "/casa/externo/temperatura"
